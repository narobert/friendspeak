...
def home(request):
    ...
    for n in needclick:
        total = total + 1
    return render_to_response("mypofile.html", {"user": request.user, "myprofileinfo": myprofileinfo, "wallposts": wallposts, "allposts": allposts, "total": total, "wallcomments": wallcomments})
